...
; ; ============================================
; ; ASCII TO INTEGER FUNCTION (64-bit)
; ; ============================================
; atoi:
...
;     mov     rdi, rax        ; rax holds pointer to string
;     xor     rax, rax        ; result = 0
;     xor     rsi, rsi        ; index = 0

; MultiLoop:
;     movzx   rcx, byte [rdi + rsi]  ; load one character
;     cmp     rcx, '0'
;     jl      Finished
;     cmp     rcx, '9'
;     jg      Finished
...
; ; ============================================
; ; INTEGER TO ASCII FUNCTION (64-bit)
; ; ============================================
; itoa:
;     mov     rcx, 10         ; divisor
;     mov     rbx, rsi        ; save buffer start
;     add     rsi, 20         ; move to end of buffer
...
;     mov     rax, rsi        ; return pointer to string
;     ret
...
;     call    itoa            ; convert integer in rax → string
;     mov     rax, rsi        ; pointer to string in rax
;     call    displaySomething
;     add     rsp, 32         ; free buffer
...
;    ; ============================================
; ; STRING PRINT + LINE FEED (64-bit)
; ; ============================================
; displayWithNewLine:
;     ; rax = pointer to string
;     push    rax             ; save string pointer
;     call    displaySomething     ; print string

;     mov     rax, 0xa        ; newline character
;     push    rax
;     mov     rax, rsp
;     call    displaySomething     ; print ""
;     add     rsp, 8          ; clean stack

;     pop     rax             ; restore original string pointer
;     ret


; ; ============================================
; ; INTEGER PRINT + LINE FEED
; ; ============================================
; intDisNewLine:
;     call    intDis
...
; lenSt:
;     push    rdi
;     mov     rdi, rax        ; rax = pointer to string
