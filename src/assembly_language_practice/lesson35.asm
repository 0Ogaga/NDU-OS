...
_close:
    ; --- 8. CLOSE THE CLIENT SOCKET (SYS_CLOSE, RAX=3) ---
    ; This is the new part for Lesson 35.
    
    ; Argument 1: File Descriptor to close
    mov     rdi, r13             ; RDI = Client FD (the accepted socket)
    
    ; Invoke SYS_CLOSE
    mov     rax, 3               ; RAX = 3 (The 64-bit syscall for SYS_CLOSE)
    syscall      
